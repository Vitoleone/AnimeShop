...
{
    public class MangaUrunlerController : Controller
    {
        private readonly ApplicationDbContext _context;
        public MangaUrunlerController(ApplicationDbContext context)
        {
            _context = context;
        }
        public IActionResult Index()
        {
            ...
            return View(urunList.Where(k => k.UrunKategori == "Manga"));
        }
    }
}
