...
{
    public class CosplayUrunlerController : Controller
    {
        private readonly ApplicationDbContext _context;
        public CosplayUrunlerController(ApplicationDbContext context)
        {
            _context = context;
        }
        public IActionResult Index()
        {
            ...
            return View(urunList.Where(k => k.UrunKategori == "Cosplay"));
        }
    }
}
